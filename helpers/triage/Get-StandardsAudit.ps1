...
.EXAMPLE
    .\helpers\triage\Get-StandardsAudit.ps1
    .\helpers\triage\Get-StandardsAudit.ps1 -Category performance -FailsOnly
    .\helpers\triage\Get-StandardsAudit.ps1 -OutputFormat Csv
