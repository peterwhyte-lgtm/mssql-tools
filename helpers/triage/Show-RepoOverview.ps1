...
Write-Host "    .\helpers\local-sql\Set-SqlConnection.ps1 -ServerInstance PROD01" -ForegroundColor White
...
Write-Host "       .\helpers\local-sql\Test-SqlConnectivity.ps1 -ServerInstance ." -ForegroundColor White
Write-Host ""
...
Write-Host "       .\helpers\triage\Find-UsefulScript.ps1 -Keyword blocking" -ForegroundColor White
Write-Host ""
