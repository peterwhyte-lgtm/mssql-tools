...
.\sql-operations\installation\configure-sql.ps1 -ApplyRecommended

# Apply to remote instance with specific values
.\sql-operations\installation\configure-sql.ps1 -ServerInstance PROD01 -MaxMemoryGB 28 -MaxDOP 4

# Review current settings without changing anything (use -WhatIf)
.\sql-operations\installation\configure-sql.ps1 -ApplyRecommended -WhatIf
#>
param(
