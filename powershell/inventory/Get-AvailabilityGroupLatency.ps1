...
.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\powershell/inventory/Get-AvailabilityGroupLatency.ps1
#>
...
$sqlScript = Join-Path $repoRoot 'sql\monitoring\Get-AvailabilityGroupLatency.sql'
