...
.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\powershell\wrappers\monitoring\Get-DatabaseFilesDetail.ps1

.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\powershell\wrappers\monitoring\Get-DatabaseFilesDetail.ps1 -ServerInstance . -OutputFormat Csv -OutputPath .\output-files\db-files.csv
#>
...
$sqlScript = Join-Path $repoRoot 'sql\monitoring\disk-space\Get-DatabaseFilesDetail.sql'
