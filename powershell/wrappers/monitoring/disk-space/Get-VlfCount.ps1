...
.EXAMPLE
.\powershell\wrappers\monitoring\Get-VlfCount.ps1

.EXAMPLE
.\powershell\wrappers\monitoring\Get-VlfCount.ps1 -ServerInstance PROD01 -OutputFormat Csv
#>
...
$sqlScript = Join-Path $repoRoot 'sql\monitoring\disk-space\Get-VlfCount.sql'
