...
.EXAMPLE
.\powershell\wrappers\monitoring\Get-AutogrowthHistory.ps1

.EXAMPLE
.\powershell\wrappers\monitoring\Get-AutogrowthHistory.ps1 -ServerInstance PROD01 -OutputFormat Csv
#>
...
$sqlScript = Join-Path $repoRoot 'sql\monitoring\disk-space\Get-AutogrowthHistory.sql'
