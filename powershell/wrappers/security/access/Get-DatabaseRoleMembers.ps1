...
.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\powershell\wrappers\security\Get-DatabaseRoleMembers.ps1

.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\powershell\wrappers\security\Get-DatabaseRoleMembers.ps1 -OutputFormat Csv -OutputPath .\output-files\db-roles.csv
#>
...
$sqlScript = Join-Path $repoRoot 'sql\security\access\Get-DatabaseRoleMembers.sql'
