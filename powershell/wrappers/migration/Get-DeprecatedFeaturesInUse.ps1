...
.EXAMPLE
.\powershell\wrappers\migration\Get-DeprecatedFeaturesInUse.ps1

.EXAMPLE
.\powershell\wrappers\migration\Get-DeprecatedFeaturesInUse.ps1 -ServerInstance PROD01 -OutputFormat Csv
#>
