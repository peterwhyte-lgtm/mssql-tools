...
.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\powershell\wrappers\migration\Get-CompatibilityLevelAudit.ps1

.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\powershell\wrappers\migration\Get-CompatibilityLevelAudit.ps1 -ServerInstance PROD01\SQL2019 -OutputFormat Csv
#>
