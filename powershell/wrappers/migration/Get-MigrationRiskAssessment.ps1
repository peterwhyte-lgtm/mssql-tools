...
.EXAMPLE
.\powershell\wrappers\migration\Get-MigrationRiskAssessment.ps1

.EXAMPLE
.\powershell\wrappers\migration\Get-MigrationRiskAssessment.ps1 -ServerInstance PROD01 -OutputFormat Csv
#>
