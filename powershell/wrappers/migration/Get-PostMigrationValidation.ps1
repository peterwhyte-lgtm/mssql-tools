...
.EXAMPLE
# Run on source
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\powershell\wrappers\migration\Get-PostMigrationValidation.ps1 -ServerInstance SOURCE -OutputFormat Csv -OutputPath .\output-files\migration\source-validation.csv

.EXAMPLE
# Run on target
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\powershell\wrappers\migration\Get-PostMigrationValidation.ps1 -ServerInstance TARGET -OutputFormat Csv -OutputPath .\output-files\migration\target-validation.csv
#>
