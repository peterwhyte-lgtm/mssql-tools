...
.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\powershell\wrappers\performance\Get-DatabaseIoUsage.ps1

.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\powershell\wrappers\performance\Get-DatabaseIoUsage.ps1 -OutputFormat Csv -OutputPath .\output-files\io-usage.csv
#>
