...
.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\powershell\wrappers\performance\Get-ActiveSessions.ps1

.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\powershell\wrappers\performance\Get-ActiveSessions.ps1 -ServerInstance . -OutputFormat Csv -OutputPath .\output-files\sessions.csv
#>
...
$sqlScript = Join-Path $repoRoot 'sql\performance\active-sessions\Get-ActiveSessions.sql'
