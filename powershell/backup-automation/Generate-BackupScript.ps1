...
.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\powershell/backup-automation/Generate-BackupScript.ps1
#>
...
Write-Host 'Generating backup script...' -ForegroundColor Cyan
