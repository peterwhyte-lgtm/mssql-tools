...
.\tools\local-sql\Test-SqlConnectivity.ps1 -ServerInstance PROD01\SQL2019
.\tools\local-sql\Test-SqlConnectivity.ps1 -ServerInstance PROD01 -Username sa -Password 'P@ss'
#>
param(
