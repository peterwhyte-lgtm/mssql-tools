...
$outDir  = Join-Path $repoRoot "web-ui\wrappers\$category"
...
.EXAMPLE
.\web-ui\wrappers\$category\$name.ps1 -ServerInstance PROD01\SQL2019 -OutputFormat Csv
#>
...
Write-Host "Created: web-ui\wrappers\$category\$name.ps1" -ForegroundColor Green
