...
.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\database-admin\powershell-scripts\reporting\Get-LongRunningQueries.ps1

.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\database-admin\powershell-scripts\reporting\Get-LongRunningQueries.ps1 -ServerInstance . -Database master -OutputFormat Csv -OutputPath .\output-files\long-running-queries.csv
#>
...
$sqlScript = Join-Path $repoRoot 'database-admin\sql-scripts\performance\Get-LongRunningQueries.sql'
