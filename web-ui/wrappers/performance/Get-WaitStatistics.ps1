...
.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\database-admin\powershell-scripts\reporting\Get-WaitStatistics.ps1 -ServerInstance . -Database master -OutputFormat Csv -OutputPath .\output-files\wait-stats.csv
#>
...
$sqlScript = Join-Path $repoRoot 'database-admin\sql-scripts\performance\Get-WaitStatistics.sql'
