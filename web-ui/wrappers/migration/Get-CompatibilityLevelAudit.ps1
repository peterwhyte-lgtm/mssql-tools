...
.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\database-admin\migration\powershell\Get-CompatibilityLevelAudit.ps1

.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\database-admin\migration\powershell\Get-CompatibilityLevelAudit.ps1 -ServerInstance PROD01\SQL2019 -OutputFormat Csv
#>
...
$sqlScript = Join-Path $repoRoot 'database-admin\migration\sql\Get-CompatibilityLevelAudit.sql'
