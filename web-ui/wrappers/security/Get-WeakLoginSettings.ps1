...
.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\database-admin\powershell-scripts\security\Get-WeakLoginSettings.ps1

.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\database-admin\powershell-scripts\security\Get-WeakLoginSettings.ps1 -OutputFormat Csv -OutputPath .\output-files\weak-logins.csv
#>
...
$sqlScript = Join-Path $repoRoot 'database-admin\sql-scripts\security\Get-WeakLoginSettings.sql'
