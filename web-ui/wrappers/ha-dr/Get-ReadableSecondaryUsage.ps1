...
.EXAMPLE
pwsh -File .\web-ui\wrappers\ha-dr\Get-ReadableSecondaryUsage.ps1
#>
...
$sqlScript = Join-Path $repoRoot 'database-admin\sql-scripts\ha-dr\Get-ReadableSecondaryUsage.sql'
