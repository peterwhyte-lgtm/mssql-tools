...
.EXAMPLE
# Remote server
.\database-admin\migration\powershell\Generate-UserMappingScript.ps1 -ServerInstance PROD01\SQL2019
...
.\database-admin\migration\powershell\Generate-UserMappingScript.ps1 -ServerInstance PROD01 -OutputPath C:\migration\user-mapping.sql
#>
...
$sqlScript = Join-Path $repoRoot 'database-admin\migration\sql\Generate-UserMappingScript.sql'
