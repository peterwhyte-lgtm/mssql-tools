...
.EXAMPLE
.\database-admin\migration\powershell\Generate-LinkedServerScript.ps1

.EXAMPLE
.\database-admin\migration\powershell\Generate-LinkedServerScript.ps1 -ServerInstance PROD01\SQL2019
...
$sqlScript = Join-Path $repoRoot 'database-admin\migration\sql\Generate-LinkedServerScript.sql'
