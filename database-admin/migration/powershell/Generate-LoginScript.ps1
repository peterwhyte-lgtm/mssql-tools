...
.EXAMPLE
# Remote server
.\database-admin\migration\powershell\Generate-LoginScript.ps1 -ServerInstance PROD01\SQL2019
...
.EXAMPLE
# SQL auth
.\database-admin\migration\powershell\Generate-LoginScript.ps1 -ServerInstance PROD01 -Username sa -Password 'P@ssw0rd'

.EXAMPLE
# Save to a specific path
.\database-admin\migration\powershell\Generate-LoginScript.ps1 -ServerInstance PROD01 -OutputPath C:\migration\logins.sql
#>
...
$sqlScript = Join-Path $repoRoot 'database-admin\migration\sql\Generate-LoginScript.sql'
