...
.DESCRIPTION
Orchestrates all database-admin\migration\sql\ assessment scripts plus key monitoring scripts against the source SQL Server.
...
.EXAMPLE
.\database-admin\migration\powershell\Invoke-PreMigrationAssessment.ps1

.EXAMPLE
.\database-admin\migration\powershell\Invoke-PreMigrationAssessment.ps1 -ServerInstance PROD01\SQL2019
#>
...
$scripts = @(
    [PSCustomObject]@{ Label = 'risk-assessment';     Path = 'database-admin\migration\sql\Get-MigrationRiskAssessment.sql' }
    [PSCustomObject]@{ Label = 'deprecated-features'; Path = 'database-admin\migration\sql\Get-DeprecatedFeaturesInUse.sql' }
    [PSCustomObject]@{ Label = 'compat-level-audit';  Path = 'database-admin\migration\sql\Get-CompatibilityLevelAudit.sql' }
    [PSCustomObject]@{ Label = 'login-audit';         Path = 'database-admin\migration\sql\Get-MigrationLoginAudit.sql' }
    ...
    [PSCustomObject]@{ Label = 'agent-jobs';          Path = 'database-admin\sql-scripts\monitoring\Get-SqlAgentJobOverview.sql' }
    [PSCustomObject]@{ Label = 'linked-servers';      Path = 'database-admin\sql-scripts\monitoring\Get-LinkedServerAndJobInventory.sql' }
    [PSCustomObject]@{ Label = 'ag-state';            Path = 'database-admin\sql-scripts\ha-dr\Get-AvailabilityGroupReplicaState.sql' }
    [PSCustomObject]@{ Label = 'sysadmin-members';    Path = 'database-admin\sql-scripts\security\Get-SysadminMembers.sql' }
    [PSCustomObject]@{ Label = 'security-surface';    Path = 'database-admin\sql-scripts\security\Get-DatabaseMailAndXpCmdShell.sql' }
