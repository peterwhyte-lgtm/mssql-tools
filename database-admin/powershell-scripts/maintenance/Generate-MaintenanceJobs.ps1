...
.EXAMPLE
.\database-admin\powershell-scripts\maintenance\Generate-MaintenanceJobs.ps1

.EXAMPLE
.\database-admin\powershell-scripts\maintenance\Generate-MaintenanceJobs.ps1 -ServerInstance PROD01\SQL2019
#>
...
$sqlScript = Join-Path $repoRoot 'database-admin\sql-scripts\maintenance\Generate-MaintenanceJobs.sql'
