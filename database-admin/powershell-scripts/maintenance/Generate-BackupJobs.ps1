...
.EXAMPLE
.\database-admin\powershell-scripts\maintenance\Generate-BackupJobs.ps1

.EXAMPLE
.\database-admin\powershell-scripts\maintenance\Generate-BackupJobs.ps1 -ServerInstance PROD01\SQL2019
...
$sqlScript = Join-Path $repoRoot 'database-admin\sql-scripts\maintenance\Generate-BackupJobs.sql'
