...
.EXAMPLE
powershell -ExecutionPolicy Bypass -File .\database-admin\powershell-scripts\inventory\Get-OldestBackupFolderFiles.ps1 -Path E:\Backups

.EXAMPLE
powershell -ExecutionPolicy Bypass -File .\database-admin\powershell-scripts\inventory\Get-OldestBackupFolderFiles.ps1 -Path \\BackupMedia\Backups -ThresholdDays 45
#>
