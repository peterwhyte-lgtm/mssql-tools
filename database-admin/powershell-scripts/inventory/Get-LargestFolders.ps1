...
.EXAMPLE
powershell -ExecutionPolicy Bypass -File .\database-admin\powershell-scripts\inventory\Get-LargestFolders.ps1

.EXAMPLE
powershell -ExecutionPolicy Bypass -File .\database-admin\powershell-scripts\inventory\Get-LargestFolders.ps1 -DriveLetter D -Top 20
#>
