...
pwsh -ExecutionPolicy Bypass -File .\database-admin\powershell-scripts\lab\Remove-DatabasesByPrefix.ps1 -Prefix migdb -Confirm

.EXAMPLE
# Drop immediately without prompting
pwsh -ExecutionPolicy Bypass -File .\database-admin\powershell-scripts\lab\Remove-DatabasesByPrefix.ps1 -Prefix migdb -Force
#>
