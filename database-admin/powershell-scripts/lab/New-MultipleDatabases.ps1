...
.EXAMPLE
pwsh -ExecutionPolicy Bypass -File .\database-admin\powershell-scripts\lab\New-MultipleDatabases.ps1 -DatabaseCount 20 -Prefix testdb

.EXAMPLE
pwsh -ExecutionPolicy Bypass -File .\database-admin\powershell-scripts\lab\New-MultipleDatabases.ps1 -DatabaseCount 100 -Prefix migdb -InitialSizeMB 50
#>
