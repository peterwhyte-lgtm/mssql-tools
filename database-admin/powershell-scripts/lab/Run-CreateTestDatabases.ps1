...
.EXAMPLE
pwsh -ExecutionPolicy Bypass -File .\database-admin\powershell-scripts\lab\Run-CreateTestDatabases.ps1 -Count 5 -Prefix demo

.EXAMPLE
pwsh -ExecutionPolicy Bypass -File .\database-admin\powershell-scripts\lab\Run-CreateTestDatabases.ps1 -Count 20 -Prefix migdb -DataSizeMB 50
#>
...
$scriptPath = Join-Path $repoRoot 'database-admin\sql-scripts\lab\New-TestDatabases.sql'
