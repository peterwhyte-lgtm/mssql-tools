...
.\database-admin\powershell-scripts\reporting\Invoke-HealthCheckCollection.ps1 -ServerInstance NEWPRI
...
```powershell
.\database-admin\powershell-scripts\reporting\Invoke-HealthCheckCollection.ps1 -ServerInstance PROD01-NEW
.\database-admin\powershell-scripts\reporting\Review-HealthCheckOutput.ps1
```
